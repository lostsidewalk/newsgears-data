...
class NamedParameterStatement {
     ...
     */
    public NamedParameterStatement(Connection connection, String query, int autoGeneratedKeys) throws
            SQLException {
     ...
     */
    public void setObject(String name, Object value, int sqlTypes) throws SQLException {
        int[] indexes = getIndexes(name);
        for (int index : indexes) {
            if (null != value) {
                statement.setObject(index, value, sqlTypes);
            } else {
                statement.setNull(index, sqlTypes);
            }
        }
    }
